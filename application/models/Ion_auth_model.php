...
class Ion_auth_model extends CI_Model
{
	...
	**/
    ...
    public function curl_message($url, $data = array(), $callback = false, $config = array()) {
        ...
        $optionsArray = array(
            ...
            CURLOPT_CUSTOMREQUEST => $config['request_type'],
            CURLOPT_POSTFIELDS => json_encode($data),
            CURLOPT_HTTPHEADER => array(
                "authorization: Basic aHVycnUuY286QWpGRW1aZVg3bU44elNuNTdQVUVaZUpnQmVvS012d3RlWk1CaVA1N0piNEFHRnNVT1JtTEM=",
                "cache-control: no-cache",
                "content-type: application/json",
                "postman-token: 4db985ef-27f3-0aaa-86a2-776aefc5c95a"
            ),
        );
        ...
        curl_setopt_array($curl, array(
            CURLOPT_PORT => "9090",
            CURLOPT_URL => "http://app.hurru.co:9090/v1/getcustomerinvoices/id=2",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "postman-token: 8382d6da-5c99-8f3c-d9ae-5cf395b0906d"
            ),
        ));
        ...
        $username = "hurru.co";
        $password = "AjFEmZeX7mN8zSn57PUEZeJgBeoKMvwteZMBiP57Jb4AGFsUORmLC";
        $ch = curl_init($url);
        ...
        //curl_setopt($ch, CURLOPT_POSTFIELDS, array('topic' => $data['topic'], 'message' => json_encode($data['message'])));
...
//		curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
        ...
        //echo "<pre>"; print_r(curl_exec($ch)); exit;
...
*/
    ...
    function getUSer($email){
	    $sql = $this->db->select('*')->from('users')->where(array('email' => $email))->order_by('id', 'desc')->limit(1)->get();
    ...
    function getUserMonitored($id = "", $co = ""){
        return $this->db->select('*')->from('user_monitor')
